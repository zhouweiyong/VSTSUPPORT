...
public class VSTFlipLayout extends ViewGroup {

    public  final String TAG = "slide";
    public  final boolean DEBUG = Log.isLoggable(TAG, Log.VERBOSE);
    ...
    public VSTFlipLayout(Context context) {
        this(context, null);
    }

    public VSTFlipLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VSTFlipLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.VSTFlipLayout, defStyleAttr, 0);
        mPercent = a.getFloat(R.styleable.VSTFlipLayout_percent, DEFAULT_PERCENT);
        mDuration = a.getInt(R.styleable.VSTFlipLayout_duration, DEFAULT_DURATION);
        mDefaultPanel = a.getInt(R.styleable.VSTFlipLayout_default_panel, 0);
        a.recycle();
