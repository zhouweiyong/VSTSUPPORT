 ...
 */
public class InventoryDeptSelectAdapter extends BaseAda<BusinessDepartmentBean> {

    public InventoryDeptSelectAdapter(Context context) {
        super(context);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vh.select_tv.setText(getItem(position).businessDepartment);
