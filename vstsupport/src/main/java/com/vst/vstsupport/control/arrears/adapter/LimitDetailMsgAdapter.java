 ...
 * Description:聊天消息适配器
 */
public class LimitDetailMsgAdapter extends BaseAda<LimitDetailMsgBean> {
//    LimitMsgIMDetailActivity activity;
//    LimitDetailActivity limitDetailActivity;
//    String str;

    public LimitDetailMsgAdapter(Context context) {
        super(context);
//        this.str=str;
//        if (str.equals("LimitDetailActivity")){
//
//        limitDetailActivity= (LimitDetailActivity) context;
//        }else{
//
//        activity = (LimitMsgIMDetailActivity) context;
//        }
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (!bean.SEND_ACCOUNT.equals(VstApplication.getInstance().getUserBean().getAccount())) {//发送者!=登录者,别人发过来的信息
            ...
            if (LimitDetailActivity.accountReceive.equals(bean.SEND_ACCOUNT)){
                vh.message_des_tv.setText("回复"+bean.SOURCE_ACCOUNT+":"+bean.CONTENT);
            }else{
            ...
            if (LimitDetailActivity.accountReceive.equals(bean.SEND_ACCOUNT)){
                vh.message_des_tv_right.setText("回复"+bean.SOURCE_ACCOUNT+":"+bean.CONTENT);
            }else{
                vh.message_des_tv_right.setText(bean.CONTENT);
            }
        }
