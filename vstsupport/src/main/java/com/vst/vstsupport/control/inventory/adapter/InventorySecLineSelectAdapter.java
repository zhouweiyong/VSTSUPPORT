 ...
 * Date:    ${Date}
 * Description:库存积压情况下的二级线适配器
 */
public class InventorySecLineSelectAdapter extends BaseAda<SecendLevelLineBean> {

    public InventorySecLineSelectAdapter(Context context) {
        super(context);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vh.select_tv.setText(getItem(position).secendLevelLine);
